...
public interface IModeratorStats {
    ...
    /**
     * @return The moderation factor of the moderator. Theoretically, a value of x means that (1 - e^(-x)) fast neutrons are
     * converted to slow neutrons in one meter.
     */
    double getModerationFactor();

    /**
     * @return The absorption factor of the moderator. Theoretically, a value of x means that (1 - e^(-x)) slow neutrons are

...
public class MetaTileEntityNaturalDraftCoolingTower extends CachedPatternRecipeMapMultiblock {
    ...
    @NotNull
    private static final SoftTemplate TEMPLATE = TemplatePool.getInstance().register("supercritical:natural_draft_cooling_tower", () ->
            DeclarativePatternBuilder.start()
                    ...
                    .aisle("     CCCCC OOO ", "     CCCCC OSO ", "     CCCCC     ", "               ", "               ",
                            ...
                            "               ", "               ", "               ", "               ", "               ",
                            "               ")
                    .where('S', selfPredicate(MetaTileEntityNaturalDraftCoolingTower.class))
                    .where('O', states(getCasingState())
                            .energyInput().maintenance().fluidOutput())
                    .where('I',
